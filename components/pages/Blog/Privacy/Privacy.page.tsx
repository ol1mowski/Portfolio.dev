      ...
      <section className={s.container__content}>
        ...
        <ol className={s.container__content__ol}>
          <li>
            ...
            <b>oliwiermarkiewicz.pl</b>
          </li>
          <li>
            Operatorem serwisu oraz Administratorem danych osobowych jest: Oliwier Markiewicz{' '}
          </li>

          <li>
            Adres kontaktowy poczty elektronicznej operatora: oliwier.markiewicz.dev@gmail.com
          </li>
        ...
        <br />
        <Caption type="sub" value="2. Wybrane metody ochrony danych stosowane przez Operatora" />
        <br />
        <ol className={s.container__content__ol}>
          <li>
        ...
        <br />
        <ol className={s.container__content__ol}>
          <li>Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora: Vercel</li>
        ...
        <ol className={s.container__content__ol}>
          <li>
            ...
            <ul>
              <li>
                osoby upoważnione przez nas, pracownicy i współpracownicy, którzy muszą mieć dostęp
        ...
        <ol className={s.container__content__ol}>
          ...
          <li>
            ...
            administratorem, Operator nie przekazuje od siebie żadnych dodatkowych danych osobowych
            serwisowi Facebook. Usługa bazuje na wykorzystaniu ciasteczek w urządzeniu końcowym
            użytkownika.
          </li>
          <li>
