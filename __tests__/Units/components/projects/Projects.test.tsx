...
vi.mock(
  '../../../../components/pages/Projects/ProjectContainer/ProjectContainer.component',
  () => ({
    default: (props: any) => (
...
vi.mock(
  '../../../../components/pages/Projects/ProjectContainer/ProjectImage/ProjectImage.component',
  () => ({
...
vi.mock(
  '../../../../components/pages/Projects/ProjectContainer/ProjectTitle/ProjectTitle.component',
  () => ({
    default: (props: any) => (
...
vi.mock(
  '../../../../components/pages/Projects/ProjectContainer/ProjectDescription/ProjectDescription.component',
  () => ({
    default: (props: any) => (
      <div data-testid="project-description">Description: {props.description}</div>
    ),
  })
);

vi.mock(
  '../../../../components/pages/Projects/ProjectContainer/ProjectTools/ProjectTools.component',
  () => ({
    default: (props: any) => (
      <div data-testid="project-tools">Technologies: {props.technologies.join(', ')}</div>
    ),
  })
);

vi.mock(
  '../../../../components/pages/Projects/ProjectContainer/ProjectCta/ProjectCta.component',
  () => ({
    default: (props: any) => (
